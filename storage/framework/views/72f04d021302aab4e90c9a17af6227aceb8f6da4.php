...
unset($__errorArgs, $__bag); ?>" name="fname" id="fname" value="<?php echo e(old('fname')); ?>" required autocomplete="fname" autofocus placeholder="Your Firstname"/>
...
unset($__errorArgs, $__bag); ?>" name="lname" id="lname" value="<?php echo e(old('lname')); ?>" required autocomplete="lname" autofocus placeholder="Your Lastname"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="signup-image">
                    <figure><img src="<?php echo e(asset('authentication/images/signup-image.jpg')); ?>" alt="sing up image"></figure>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Dynamic Website Project\SAWMS\SAROS-orderSYS\resources\views/auth/register.blade.php ENDPATH**/ ?>